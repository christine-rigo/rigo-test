...
<div class="service-container">
	...
	<div class="service-container-body">
		<div class="service-container-body-left">
			<img
				...
				src="/services-img/volta-site-traffic.png"
				alt="rigo"
			/>
			<img
				class="service-container-body-left-img hidden-desktop"
				src="/services-img/site-traffic-volta-xs.png"
				alt="rigo"
			/>
		</div>
		<div class="service-container-body-right">
			<div class="service-container-body-right-btn-group">
				<RectangularBtn
					cta="next"
					href="/digital-advertising/volta-impressions"
					btnColor="btn-lunarblue"
				/>
				<RectangularBtn
					cta="see full case study"
					href="/casestudy/volta"
					btnColor="btn-lunarblue"
				/>
			</div>
			<RectangularBtn
				...
				href="/contact"
				btnColor="btn-lunarblue hidden-mobile"
			/>
		</div>
	</div>
	<div class="service-container-footer">
		...
		<div class="service-container-footer-description">
			During the duration of the campaign, we have seen the number of users visiting the website
			from social platforms <strong>increase by 268% / 947 users in total</strong> when compared to
			the previous period. The number of sessions also <strong>increased by 226.95% / 1,092</strong>
			sessions.
		</div>
		<a href="/contact"
			><div class="service-container-footer-btn hidden-desktop">Start your ascent</div></a
		>
	</div>
</div>
