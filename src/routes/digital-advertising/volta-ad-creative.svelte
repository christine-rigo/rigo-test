...
<div class="service-container">
    ...
    <div class="service-container-body">
        ...
        <div class="service-container-body-right">
            <div class="service-container-body-right-btn-group">
                <RectangularBtn cta="next" href="/creative/volta" btnColor="btn-lunarblue"></RectangularBtn>
    ...
    <div class="service-container-footer">
        ...
        <div class="service-container-footer-title" style="color: var(--app-color-lunarblue-contrast)">Ad Creative</div>
        <div class="service-container-footer-description">One of the top performing adverts on the LinkedIn campaign.<br>Credit: Sam Farah @Volta</div>
