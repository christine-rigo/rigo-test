...
<div class="service-container">
	...
	<div class="service-container-body">
		<div class="service-container-body-left">
			<img
				...
				src="/services-img/volta-ad-creative.png"
				alt="rigo"
			/>
			<img
				class="service-container-body-left-img hidden-desktop"
				src="/services-img/ad-creatove-volta-xs.png"
				alt="rigo"
			/>
		</div>
		<div class="service-container-body-right">
			<div class="service-container-body-right-btn-group">
				<RectangularBtn cta="next" href="/creative/volta" btnColor="btn-lunarblue" />
				<RectangularBtn
			...
			<button
				class="btn-lunarblue hidden-mobile hidden-mobile service-container-body-right-btn"
				style="width:100%"
	...
	<div class="service-container-footer">
		...
		<div class="service-container-footer-title" style="color: var(--app-color-lunarblue-contrast)">
			Ad Creative
		</div>
		<div class="service-container-footer-description">
			One of the top performing adverts on the LinkedIn campaign.<br />Credit: Sam Farah @Volta
		</div>
		<a href="/contact"
